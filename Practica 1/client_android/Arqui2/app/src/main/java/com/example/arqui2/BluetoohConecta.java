...
public class BluetoohConecta extends AppCompatActivity {
    //1)
    // Depuración de LOGCAT
    private static final String TAG = "BluetoohConecta";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bluetooh_conecta);
    }
    @Override
    public void onResume()
    {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter(this,android.R.layout.simple_list_item_1, list);
        // Presenta los disposisitivos vinculados en el ListView

        IdLista = (ListView) findViewById(R.id.listaD);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(BluetoohConecta.this, ConectionApi.class);//<-<- PARTE A MODIFICAR >->->
